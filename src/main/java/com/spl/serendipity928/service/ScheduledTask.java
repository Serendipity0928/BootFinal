...
public class ScheduledTask {
    ...
    public void studentReport() {
        ...
        String location = "sfzs=1&bzxyy=&bzxyy_other=&brsfzc=1&tw=&sfcxzz=&zdjg=&zdjg_other=&sfgl=&gldd=&gldd_other=&glyy=&glyy_other=&gl_start=&gl_end=&sfmqjc=&sfzc_14=1&sfqw_14=0" +
        ...
        List<ReportInfo> reportInfos = reportInfoDao.filterReportInfoList(curTime);
        ...
        reportInfos.forEach(reportInfo -> {
            ...
            String data = location.replace("${name}", reportInfo.name).replace("${number}", reportInfo.studentID);
            String result = HttpClient.doPostOrGet(url, "POST", data, reportInfo.cookies);
