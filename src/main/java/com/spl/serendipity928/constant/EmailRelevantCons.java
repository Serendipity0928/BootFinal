package com.spl.serendipity928.constant;

public class EmailRelevantCons {

    public final static String REPORT_URL = "https://app.buaa.edu.cn/buaaxsncov/wap/default/save";
    public final static String REPORT_LOCATION = "sfzs=1&bzxyy=&bzxyy_other=&brsfzc=1&tw=&sfcxzz=&zdjg=&zdjg_other=&sfgl=&gldd=&gldd_other=&glyy=&glyy_other=&gl_start=&gl_end=&sfmqjc=&sfzc_14=1&sfqw_14=0" +
            ...
            "&gwdz=&is_move=0&move_reason=&move_remark=&realname=${name}&number=${number}&uid=376685&created=1623661268&date=20210614&created_uid=300068&id=2994284&gwszdd=";

    public final static String SPECIFIED_CONTENT = "<!doctype html>\n" +
            "<html lang=\"en\">\n" +
            "<head>\n" +
            "    <meta charset=\"UTF-8\">\n" +
            "    <title>${title}</title>\n" +
